...
export default (variables = variable) => {
  ...
  const headerTheme = {
    ...
    ".transparent": {
      ...
      // shadowRadius: 6,
      // shadowOpacity: 1,
      paddingTop: platform === "android" ? 0.02 * height : undefined,
      height: platform === "android" ? 0.1 * height : variables.toolbarHeight
    },
    ".noShadow": {
    ...
    // shadowRadius: platform !== "ios" && platformStyle === "material" ? 1.2 : 1.2,
    top: 0,
    left: 0,
    right: 0,
  };
